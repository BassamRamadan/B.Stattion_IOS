...
class common {
    ...
    struct refs
    {
        ...
        static let databaseChatsMessage = databaseRoot.child("chats").child("chatsMessage")
        static let databaseChatsRoom = databaseRoot.child("chats").child("chatsRoom")
        static let databaseUsers = databaseRoot.child("users")
    }
    static var currentArabic = CashedData.getLanguage() == "ar"
    
    static let languagesArrays = ["العربيه","English"]
    static let guideType = [NSLocalizedString("expert", comment: "high guide rating"),NSLocalizedString("creator", comment: "mid guide rating"),NSLocalizedString("superior", comment: "low guide rating")]
    class func drowNotficationButton()->UIButton {
        let notifBtn: UIButton = UIButton(type: UIButton.ButtonType.custom)
        notifBtn.setImage(UIImage(named: "Action_bar/ic_notifcation"), for: [])
