...
class GeneratePath: common {
    ...
    @IBAction func checkedAndUnchecked(_ sender: Any) {
        if   (sender as! UIButton).imageView?.image == UIImage(named: "ic_unchecked"){
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.wifiButton.setImage(#imageLiteral(resourceName: "ic_unchecked"), for: .normal)
        self.airButton.setImage(#imageLiteral(resourceName: "ic_unchecked"), for: .normal)
        self.shadingButton.setImage(#imageLiteral(resourceName: "ic_unchecked"), for: .normal)
            ...
            do {
                ...
                if error == nil{
                    if success{
                        ...
                        self.Model.text = ""
                        self.carType.text = ""
                        self.wifi = false; self.shading = false; self.airConditioning = false
                    }else{
